const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>A transformative documentary series <br/>A journey with international students<br/>A bold invitation to Chinese audiences</div>',
