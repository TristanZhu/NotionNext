...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '12ff648cf9c380999fadfd9886017a21,en:12ff648cf9c3804f951acf9a0ea5e5f8',
  ...
  GREETING_WORDS:
    ...
    'Welcome to Bridging Light',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'TristanZhu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A documentary series', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Bridging Light', // 网站关键词 英文逗号隔开
  ...
  NOTION_PROPERTY_NAME: {
    ...
    date: process.env.NEXT_PUBLIC_NOTION_PROPERTY_DATE || '',
